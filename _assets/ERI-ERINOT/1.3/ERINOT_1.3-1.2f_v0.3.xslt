...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:vmf="http://www.altova.com/MapForce/UDF/vmf" xmlns:ns0="https://ris.cesni.eu/_assets/ERI-ERINOT/1.3" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="vmf ns0 xs">
  <xsl:template name="vmf:vmf1_inputtoresult">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$input='150'">
        <xsl:value-of select="'V5'"/>
      </xsl:when>
      <xsl:when test="$input='151'">
        <xsl:value-of select="'V5'"/>
      </xsl:when>
      <xsl:otherwise>
        <xsl:value-of select="''"/>
  ...
  <xsl:template match="/">
    ...
    <ERINOT xmlns="http://www.risexpertgroups.org/ERINOT1.2">
      <xsl:attribute name="xsi:schemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">http://www.risexpertgroups.org/ERINOT1.2</xsl:attribute>
      <xsl:attribute name="xsi:type" namespace="http://www.w3.org/2001/XMLSchema-instance">Type_ERINOT_v1.2</xsl:attribute>
      <xsl:for-each select="ns0:ERINOT">
        <xsl:variable name="var2_cur" select="."/>
        <xsl:attribute name="VersionMajor" namespace="">1</xsl:attribute>
        <xsl:attribute name="VersionMinor" namespace="">2</xsl:attribute>
      </xsl:for-each>
      <xsl:for-each select="ns0:ERINOT">
        ...
        <MessageId>
          ...
          <xsl:variable name="var6_nested">
            <xsl:call-template name="vmf:vmf1_inputtoresult">
              <xsl:with-param name="input" select="string(number(ns0:MessageId/ns0:MessageFunction))"/>
            </xsl:call-template>
          </xsl:variable>
          <xsl:if test="string($var6_nested)">
            <MessageFunction>
              ...
              <xsl:value-of select="number(substring($var7_nested, 2))"/>
            </MessageFunction>
          </xsl:if>
        ...
        <xsl:for-each select="ns0:PrivacyStatement">
          ...
          <PrivacyStatement>
            <xsl:choose>
              <xsl:when test="translate(normalize-space(string(.)), ' 0false', '')">
        ...
        <Transport>
          ...
          <TransportDimensions>
            ...
            <Tonnage>
              <xsl:variable name="var17_nested">
                <xsl:choose>
                  <xsl:when test="(ns0:Transport/ns0:TransportDimensions/ns0:Tonnage &gt; 99999)">
              ...
              <xsl:value-of select="floor($var17_nested)"/>
            </Tonnage>
          ...
          <TransportLocations>
            <PortOfDeparture>
              ...
              <xsl:for-each select="ns0:Transport/ns0:TransportLocations/ns0:PortOfDeparture/ns0:ObjectCode">
            ...
            <xsl:for-each select="ns0:Transport/ns0:TransportLocations/ns0:PassagePoint">
              ...
              <PassagePoint>
                ...
                <xsl:for-each select="ns0:ObjectCode">
            ...
            <xsl:for-each select="ns0:Transport/ns0:TransportLocations/ns0:RoutePoints">
              ...
              <RoutePoints>
                <RoutePoint>
                  ...
                  <xsl:for-each select="ns0:RoutePoint/ns0:ObjectCode">
            ...
            <PortOfDestination>
              ...
              <xsl:for-each select="ns0:Transport/ns0:TransportLocations/ns0:PortOfDestination/ns0:ObjectCode">
        ...
        <MessageSenderAddress>
          <NameAddress>
            ...
            <xsl:for-each select="ns0:MessageSenderAddress/ns0:NameAddress/ns0:VATNumber">
        ...
        <xsl:for-each select="ns0:MessageReceiverAddress">
          ...
          <MessageReceiverAddress>
            <NameAddress>
              ...
              <xsl:for-each select="ns0:NameAddress/ns0:VATNumber">
              ...
              <Consignment>
                ...
                <xsl:for-each select="ns0:CargoReceiver">
                  ...
                  <CargoReceiver>
                    ...
                    <xsl:for-each select="ns0:VATNumber">
                ...
                <xsl:for-each select="ns0:CargoHandling">
                    ...
                    <GoodsItem>
                      ...
                      <xsl:for-each select="ns0:GoodsDescription">
                        ...
                        <GoodsDescription>
                          ...
                          <xsl:for-each select="(./ns0:NSTCode)[(string-length(string(.)) = 6)]">
                      ...
                      <xsl:for-each select="ns0:DangerousGoodsInfo">
                        ...
                        <DangerousGoodsInfo>
                          <DangerousGoods>
                            <Regulation>
                              <xsl:choose>
                                <xsl:when test="ns0:DangerousGoods/ns0:Regulation = 'ADN'">ANR</xsl:when>
                                <xsl:otherwise>
                          ...
                          <Synonym>
                            <xsl:value-of select="ns0:ProperShippingName"/>
                          </Synonym>
                        </DangerousGoodsInfo>
                      </xsl:for-each>
